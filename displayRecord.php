...
$sql = "SELECT * FROM club_register WHERE studentID= '$studentID'";
$result = $conn->query($sql);
//check if records were returned
if ($result->num_rows > 0) {
//create a table to display the record
echo 'Selected record as the following: <br><br>';
echo '<p><table cellpadding=10 cellspacing=0 border=1 align="center" class="record-table">';
...
<td align="center"><b>Club Interested</b></td>
</tr>';
